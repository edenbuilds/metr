...
final class TidemarkPanel: NSPanel {
...
final class PanelController: NSObject, NSWindowDelegate {
    ...
    private var panel: TidemarkPanel!
    ...
    private func build() {
        ...
        panel.delegate = self
        panel.identifier = NSUserInterfaceItemIdentifier("tidemark-panel")
        panel.title = "Tidemark"
        panel.setAccessibilityTitle("Tidemark")
