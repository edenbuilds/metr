...
enum Theme {
    ...
    /// Fill behind cards. `quinary`-weight so it reads as a surface, not a box.
    static let cardFill = Color(nsColor: .quaternaryLabelColor).opacity(0.09)
    static let cardStroke = Color(nsColor: .separatorColor)
    static let meterTrack = Color(nsColor: .quaternaryLabelColor).opacity(0.28)
}
